...
class GlobalConfig:
    ...
    llm_model = '/home/lmdrive/workspace/LMDrive/weights/llama-7b'
    preception_model = 'memfuser_baseline_e1d3_return_feature'
    preception_model_ckpt = '/home/lmdrive/workspace/LMDrive/weights/vision-encoder-r50.pth.tar'
    lmdrive_ckpt = '/home/lmdrive/workspace/LMDrive/weights/llama-7b-checkpoint.pth'
